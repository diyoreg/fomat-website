...
import type { CategoryImageMap, CategorySection } from "@/sanity/lib/types";
...
export default function CatalogContent({ categoryImages }: { categoryImages: CategoryImageMap }) {
        ...
        <div ref={grid.ref} className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {categories.map((cat, i) => {
              const bgImage = categoryImages[cat.section];
              return (
              <Link
                key={cat.href}
                href={cat.href}
              ...
              >
                ...
                <div className={`absolute inset-0 bg-gradient-to-t ${bgImage ? "from-black/70 via-black/25" : "from-black/40 via-transparent"} to-transparent`} />
