...
type Props = {
  shawCollections: LvtCollection[];
  fomatCollections: LvtCollection[];
};
...
export default function LvtContent(props: Props) {
  return (
    <Suspense fallback={null}>
      <LVTPageContent {...props} />
    </Suspense>
  );
}

function LVTPageContent({ shawCollections, fomatCollections }: Props) {
  ...
  const collections = isShaw ? shawCollections : fomatCollections;
