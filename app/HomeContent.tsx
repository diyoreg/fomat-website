...
import SanityImageCmp from "@/components/ui/SanityImage";
import type { CategoryImageMap, CategorySection, SanityImage } from "@/sanity/lib/types";
...
export default function HomeContent({ sliderImages, categoryImages }: Props) {
      ...
      <section className="py-24 bg-[#fafaf8]">
        <div ref={productsSection.ref} className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {products.map((p, i) => {
              const bgImage = categoryImages[p.section];
              return (
              <Link
                key={p.href}
                href={p.href}
              ...
              >
                ...
                <div className={`absolute inset-0 bg-gradient-to-t ${bgImage ? "from-black/70 via-black/20" : "from-black/50 via-transparent"} to-transparent`} />
